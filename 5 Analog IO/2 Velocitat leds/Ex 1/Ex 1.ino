...
const byte led3 = 7;          // donar nom al pin 7 de l’Arduino
const byte led4 = 8;          // donar nom al pin 8 de l’Arduino
const byte led5 = 9;          // donar nom al pin 9 de l’Arduino
const byte led6 = 10;         // donar nom al pin 10 de l’Arduino
const byte led7 = 11;         // donar nom al pin 11 de l’Arduino
const byte led8 = 12;         // donar nom al pin 12 de l’Arduino
const byte pot0 = A0;         // donar nom al pin A0 de l’Arduino

unsigned long velocitat = 60;          // velocitat de l'acció en ms
...
void loop()
{
  ...
  digitalWrite(led2, HIGH);    // posar a 5V el pin 6
  ...
  digitalWrite(led6, HIGH);    // posar a 5V el pin 10
