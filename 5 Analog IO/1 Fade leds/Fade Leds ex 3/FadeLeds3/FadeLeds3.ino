...
void loop()
{
  ...
  {
  analogWrite(led0, 0);     // posar PxºWM del pin 3 a 0
  ...
  analogWrite(led3, 0);     // posar PWM del pin 9 a 0
  analogWrite(led4, 0);     // posar PWM del pin 10 a 0
  analogWrite(led5, 180);     // posar PWM del pin 11 a 0
  ...
  analogWrite(led4, 180);     // posar PWM del pin 10 a 30
  ...
  analogWrite(led3, 180);     // posar PWM del pin 9 a 100
  ...
  analogWrite(led2, 180);    // posar PWM del pin 6 a 165
  ...
  analogWrite(led0, 0);    // posar PWM del pin 3 a 180
  analogWrite(led1, 180);    // posar PWM del pin 5 a 180
  analogWrite(led2, 80);    // posar PWM del pin 6 a 180
  analogWrite(led3, 30);    // posar PWM del pin 9 a 180
  analogWrite(led4, 0);    // posar PWM del pin 10 a 180
  analogWrite(led5, 0);    // posar PWM del pin 11 a 180
   
  delay(velocitat);           
  
  analogWrite(led0, 180);    // posar PWM del pin 3 a 165
  ...
  analogWrite(led0, 180);     // posar PWM del pin 3 a 0
  analogWrite(led1, 0);     // posar PWM del pin 5 a 0
  analogWrite(led2, 0);     // posar PWM del pin 6 a 0
  analogWrite(led3, 0);     // posar PWM del pin 9 a 0
  analogWrite(led4, 0);     // posar PWM del pin 10 a 0
  ...
  analogWrite(led1, 180);     // posar PWM del pin 5 a 0
  analogWrite(led2, 0);     // posar PWM del pin 6 a 0
  analogWrite(led3, 0);     // posar PWM del pin 9 a 0
  analogWrite(led4, 0);     // posar PWM del pin 10 a 0
  analogWrite(led5, 0);     // POSAR PWM del pin 11 a 0
  ...
  analogWrite(led2, 180);     // posar PWM del pin 6 a 0
  analogWrite(led3, 0);     // posar PWM del pin 9 a 0
  analogWrite(led4, 0);     // posar PWM del pin 10 a 0
  analogWrite(led5, 0);     // POSAR PWM del pin 11 a 0
  ...
  analogWrite(led3, 180);     // posar PWM del pin 9 a 0
  analogWrite(led4, 0);     // posar PWM del pin 10 a 0
  analogWrite(led5, 0);     // POSAR PWM del pin 11 a 0
  ...
  analogWrite(led4, 180);     // posar PWM del pin 10 a 0
  analogWrite(led5, 0);     // POSAR PWM del pin 11 a 0
